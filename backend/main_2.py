...
from src.utils import DemoImageData, DemoVideoData, identify_modality
...
parser.add_argument(
    "--input-filename", 
    type = str, 
    default = "data/f722c05d-fd58-4072-a7cf-dcd335cb622e/pexels-jopwell-2422290.jpg",
    help = "Name of the clip file to process (with extension)."
)
parser.add_argument(
    "--output-dir", 
    type = str, 
    default = "data", 
    help = "Name of the folder where to save the output."
)
...
parser.add_argument(
    "--ckpt-path",
    type=str,
    default="src/checkpoints/gat_stwsge_gaze360_gf.ckpt",
...
def load_head_detection_model(device):
    ...
    ckpt_path = "src/weights/crowdhuman_yolov5m.pt"
